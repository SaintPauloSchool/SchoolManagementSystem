...
public class SysDictData extends BaseEntity
{
    ...
    @Size(min = 0, max = 100, message = "字典標籤長度不能超過100個字符")
    ...
    @Size(min = 0, max = 100, message = "字典鍵值長度不能超過100個字符")
    ...
    @Size(min = 0, max = 100, message = "字典類型長度不能超過100個字符")
    ...
    @Size(min = 0, max = 100, message = "樣式屬性長度不能超過100個字符")
