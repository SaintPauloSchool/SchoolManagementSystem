package com.sms.common.utils.poi;
...
import com.sms.common.annotation.Excel.Type;
import com.sms.common.annotation.Excels;
import com.sms.common.config.OverallSituationConfig;
import com.sms.common.core.domain.AjaxResult;
import com.sms.common.core.text.Convert;
import com.sms.common.exception.UtilException;
import com.sms.common.utils.DateUtils;
import com.sms.common.utils.DictUtils;
import com.sms.common.utils.StringUtils;
import com.sms.common.utils.file.FileTypeUtils;
import com.sms.common.utils.file.FileUtils;
import com.sms.common.utils.file.ImageUtils;
import com.sms.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public List<T> importExcel(String sheetName, InputStream is, int titleNum) throws Exception
    {
        ...
        // 獲取最後一個非空行的行下標，比如總行數爲n，則返回的爲n-1
    ...
    public AjaxResult exportExcel()
    {
        ...
        {
            log.error("導出Excel異常{}", e.getMessage());
            throw new UtilException("導出Excel失敗，請聯繫網站管理員！");
        }
        finally
        {
            IOUtils.closeQuietly(wb);
    ...
    public void setCellVo(Object value, Excel attr, Cell cell)
    {
        if (ColumnType.STRING == attr.cellType() || ColumnType.TEXT == attr.cellType())
        {
            ...
            // 對於任何以表達式觸發字符 =-+@開頭的單元格，直接使用tab字符作爲前綴，防止CSV注入。
    ...
    public void setDataValidation(Excel attr, Row row, int column)
    {
        ...
        if (StringUtils.isNotEmpty(attr.prompt()) || attr.combo().length > 0 || attr.comboReadDict())
        {
            ...
            {
                // 如果下拉數大於15或字符串長度大於255，則使用一個新sheet存儲，避免生成的模板下拉值獲取不到
    ...
    /**
     * 設置某些列的值只能輸入預製的數據,顯示下拉框（兼容超出一定數量的下拉框）.
     * 
    ...
    public void setXSSFValidationWithHidden(Sheet sheet, String[] textlist, String promptContent, int firstRow, int endRow, int firstCol, int endCol)
    {
        ...
        Sheet hideSheet = wb.createSheet(hideSheetName); // 用於存儲 下拉菜單數據
